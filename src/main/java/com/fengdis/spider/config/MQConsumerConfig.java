...
public class MQConsumerConfig {
    ...
    public DefaultMQPushConsumer rocketMQConsumerFactory() throws Exception {
        ...
        try {
            ...
            consumer.subscribe(MqConstants.QUEUE_CHECK_PROXY_IP_AND_SAVE_TO_DB, "*");

            //consumer.start();
            logger.info("consumer is start,groupName:{},topics:{},namesrvAddr:{}",groupName,MqConstants.QUEUE_CHECK_PROXY_IP_AND_SAVE_TO_DB,namesrvAddr);
